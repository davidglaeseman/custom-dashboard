...
ALTER TABLE "pages" ADD CONSTRAINT "pages_parentId_pages_id_fk" FOREIGN KEY ("parentId") REFERENCES "public"."pages"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "pages" ADD CONSTRAINT "pages_layoutId_layouts_id_fk" FOREIGN KEY ("layoutId") REFERENCES "public"."layouts"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
